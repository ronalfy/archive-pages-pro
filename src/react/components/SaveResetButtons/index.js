...
const SaveResetButtons = ( props ) => {
	...
	const saveOptions = async () => {
		const saveOptionsPromise = SendCommand( 'dlx_app_save_options', { formData: formValues } );
	...
	const resetOptions = async () => {
		const resetOptionsPromise = SendCommand( 'dlx_app_reset_options', { formData: formValues } );
	...
	return (
		<>
			<div className="dlx-admin-component-row-button">
				<Button
					className={ classNames(
						'dlx-app__btn dlx-app__btn-primary dlx-app__btn--icon-right',
						{ 'has-error': hasErrors() },
				...
				<Button
					className={ classNames(
						'dlx-app__btn dlx-app__btn-danger dlx-app__btn--icon-right',
						{ 'has-icon': resetting },
			...
			<div className="dlx-app-admin-notices-bottom">
				<SnackPop

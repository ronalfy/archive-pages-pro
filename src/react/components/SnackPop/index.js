	...
	const getSnackBar = () => {
		return (
			<WPSnackBar
				className={
					classnames(
						`dlx-app-snackbar dlx-app-snackbar-${ notificationOptions.type }`,
						{
		...
		if ( 'critical' === notificationOptions.type ) {
			return (
				<Modal
					className={
						classnames(
							`dlx-app-modal dlx-app-modal-${ notificationOptions.type }`,
							{
				...
				>
					<Notice
						...
						inline={ false }
					/>
					<div className="dlx-app-modal-button-group">
						<Button
